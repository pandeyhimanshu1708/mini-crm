    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="card card-primary card-outline">
                ...
                <div class="card-body">
                    <form action="{{ route('notes.store') }}" method="POST">
                        @csrf
                        <input type="hidden" name="noteable_id" value="{{ $company->id }}">
                        <input type="hidden" name="noteable_type" value="App\Models\Company">
            ...
            <div class="notes-list mt-3">
                @forelse ($company->notes->sortByDesc('created_at') as $note)
                ...
                @empty
                    <p class="text-muted">No notes available for this company.</p>
                @endforelse
            </div>
            ...
            <div class="card card-primary card-outline">
                ...
                <div class="card-body">
                    <form action="{{ route('attachments.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="attachable_id" value="{{ $company->id }}">
                        <input type="hidden" name="attachable_type" value="App\Models\Company">
                        <div class="form-group">
            ...
            <div class="attachments-list mt-3">
                @forelse ($company->attachments->sortByDesc('created_at') as $attachment)
                    <div class="card card-secondary card-outline mb-2">
                ...
                @empty
                    <p class="text-muted">No attachments available for this company.</p>
                @endforelse
            </div>
        </div>
    </div>
